...
url = f"{BASE_URL}/{UrlConstants.CREATE_CLASS_RESTRICTION_TERM_ENDPOINT}"


def create_class_term_restriction(token: str, class_id: str, lesson_id: str, dt: datetime, duration: int,
